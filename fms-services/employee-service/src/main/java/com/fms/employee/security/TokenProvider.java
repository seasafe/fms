...
import static com.fms.employee.security.SecurityConstants.*;
...
public class TokenProvider implements Serializable {
	...
	public Boolean validateToken(String token, String employeeId) {
		final String tokenEmployeeId = getEmployeeIdFromToken(token);
		return (tokenEmployeeId.equalsIgnoreCase(employeeId) && !isTokenExpired(token));
	}
