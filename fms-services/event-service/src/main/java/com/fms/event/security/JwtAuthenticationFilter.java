...
import static com.fms.event.security.SecurityConstants.HEADER_EMPLOYEE_STRING;
import static com.fms.event.security.SecurityConstants.HEADER_STRING;
import static com.fms.event.security.SecurityConstants.TOKEN_PREFIX;
...
import com.fms.event.exception.CustomException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
		...
		if (header != null && header.startsWith(TOKEN_PREFIX)) {
			...
			throw new CustomException("couldn't find bearer string, will ignore the header", HttpStatus.UNAUTHORIZED);
		}
